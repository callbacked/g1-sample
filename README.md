...
**BIG GIANT DISCLAIMER:** I am not a big iOS dev, this is my first time working with the glasses combined with Swift because I wanted to use the speech recognition api, so fair warning to anyone who wants to see and modify the unpolished code I wrote with some assistance from AI. 
